...
\input{elementos-textuais/01_preliminares/00_preliminares}
\input{elementos-textuais/02_metodos-inferiores/00_metodos-inferiores}
\input{elementos-textuais/03_metodos-superiores/00_metodos-superiores}
\input{elementos-textuais/04_ordenacao-em-tempo-linear/00_ordenacao-em-tempo-linear}
\input{elementos-textuais/05_analise-empirica/00_analise-empirica}
\input{elementos-textuais/06_conclusao/00_conclusao}
