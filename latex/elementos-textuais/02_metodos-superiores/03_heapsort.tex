...
\lstinputlisting[language=C]{codigos/algoritmos/aux/heapifica.txt}
...
\lstinputlisting[language=C]{codigos/algoritmos/aux/constroi_heap.txt}
...
\lstinputlisting[language=C]{codigos/algoritmos/sup/3_heapsort.txt}
