...
\begin{figure}[H]
\Caption{\label{fig:quicksort-insercao}Número médio de movimentações (10 execuções por tamanho) realizadas pelos algoritmos Quicksort e Insercao em vetores gerados de forma pseudoaleatória.}
\centering
\includegraphics{figuras/pdf/quicksort-insercao.pdf}
\Fonte{Elaborado pelo autor}
\end{figure}

\lstinputlisting[language=C]{codigos/algoritmos/sup/5_quicksort_i.txt}
...
\lstinputlisting[language=C]{codigos/algoritmos/aux/particiona2.txt}

\begin{figure}[H]
\Caption{\label{fig:particiona_1_2}Número médio de trocas (10 execuções por tamanho) realizadas pelos métodos Particiona e Particiona2 em vetores gerados de forma pseudoaleatória.}
\centering
...
\lstinputlisting[language=C]{codigos/algoritmos/sup/6_introsort.txt}
